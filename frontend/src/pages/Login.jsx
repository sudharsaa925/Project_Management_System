...
import loginBackground from "../assets/login_background.mp4"; // Import video
...
const VideoBackground = styled.video`
  ...
  z-index: -1;
  filter: brightness(0.9); /* Slight dim for better readability */
  background-color: black; /* Fallback in case video doesn't load */
`;
